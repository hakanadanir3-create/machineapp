...
const FALLBACK: Faq[] = [
  ...
  { id: "7", question: "Bolu'da en iyi dövüş sporları salonu hangisi?", answer: "Machine Gym, boks, kickboks ve muay thai'yi sertifikalı antrenörler ve profesyonel ekipmanla (ring, kum torbası, pad seti) aynı tesiste sunan Bolu'daki dövüş sporları merkezlerinden biridir. Fitness ve personal training hizmetleriyle birlikte tek üyelikte sunulur.", category: "Hizmet", order_index: 6 },
  { id: "8", question: "Bolu'da özel boks dersi fiyatları ne kadar?", answer: "Özel boks dersi ücretleri seans sayısı ve programa göre değişir. Güncel fiyat bilgisi için /fiyatlar sayfamızı ziyaret edebilir veya /randevu üzerinden özel ders randevusu oluşturarak WhatsApp hattımızdan detaylı bilgi alabilirsiniz.", category: "Fiyat", order_index: 7 },
  { id: "9", question: "Bolu'da kickboks dersi nerede alınır?", answer: "Machine Gym, Bolu merkezde kickboks derslerini hem grup hem özel ders formatında sunar. Sıfırdan başlayanlar için temel teknik programları, deneyimli sporcular için kondisyon ve teknik geliştirme çalışmaları mevcuttur.", category: "Hizmet", order_index: 8 },
  { id: "10", question: "Gym Machine nerede, adresi nedir?", answer: "Machine Gym, Bolu şehir merkezinde, kolay ulaşım sağlayan bir konumda hizmet vermektedir. Tam adres ve yol tarifi için /iletisim sayfamızı ziyaret edebilir veya WhatsApp hattımızdan konum bilgisi isteyebilirsiniz.", category: "Genel", order_index: 9 },
];
